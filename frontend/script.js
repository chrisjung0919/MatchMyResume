...
async function analyze() {
    ...
    const uploadResponse = await fetch("https://matchmyresume-nosi.onrender.com/upload-resume", {
        method: "POST",
        body: formData
    });
    ...
    // Analyze
    const response = await fetch("https://matchmyresume-nosi.onrender.com/analyze", {
        method: "POST",
        headers: {
